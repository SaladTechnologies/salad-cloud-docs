...
<Note>This should be in the format application/json. The only required field is the sessionId. Fields marked as optional are useful for Salad in preventing the use of nodes that may trigger a node removal request in the future.</Note>
