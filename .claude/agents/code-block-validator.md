...
description:
  Validates code examples in documentation files. Use proactively when checking tutorials or how-to guides for working
  code. Validates Python syntax, Dockerfile instructions, bash commands, and JSON/YAML schemas.
