...
![Timber is the goodest boy](/managed-services/dreambooth/images/timber-photo.JPG)
...
![ngrok running](/managed-services//dreambooth/images/ngrok-launch.png)
...
Otherwise, you can install ComfyUI locally by following the instructions in the [ComfyUI GitHub Repository](https://github.com/comfyanonymous/ComfyUI). For this method, you will also need to download [Stable Diffusion XL Base]([stabilityai/stable-diffusion-xl-base-1.0](https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/resolve/main/sd_xl_base_1.0.safetensors?download=true)) and [Stable Diffusion Refiner](https://huggingface.co/stabilityai/stable-diffusion-xl-refiner-1.0/resolve/main/sd_xl_refiner_1.0.safetensors?download=true) from Huggingface, and store them in the `checkpoints` directory in your comfyui installation. This step is automated in the above `docker run` command.
...
Once ComfyUI is running, you can navigate to `http://localhost:8188` in your browser to access the interface. You'll see a screen like this:
![ComfyUI Default View](/managed-services//dreambooth/images/comfy-default.png)
...
![Timber Image With Workflow](/managed-services//dreambooth/images/timber_00009_.png)

You should see a workflow like this:

![Timber Workflow](/managed-services//dreambooth/images/workflow.png)

Find the "Load LoRA" node, and select your safetensors file from the list.

![Lora Loader](/managed-services//dreambooth/images/lora-loader.png)
...
![prompts](/managed-services//dreambooth/images/prompts.png)
...
![Timber as a steampunk engineer](/managed-services//dreambooth/images/timber_steampunk.png)
