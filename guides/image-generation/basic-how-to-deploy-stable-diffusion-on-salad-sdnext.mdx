...
![Example Image](/products/sce/images/stable-diffusion/sunset-base64-2.png)
...
```
    ...
    2. Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [Salad Public API](/reference/saladcloud-api/container_groups/create-a-container-group)
        ...
        ![Untitled](/products/sce/images/stable-diffusion/deploy-sdnext-1.png)
        ...
        ![Untitled](/products/sce/images/stable-diffusion/deploy-sdnext-2.png)
        ...
        ![Untitled](/products/sce/images/stable-diffusion/deploy-a1111-3.png)
        ...
        ![Untitled](/products/sce/images/stable-diffusion/deploy-sdnext-3.png)
...
## Interact with Your Deployment
    ...
    1. Wait for the deployment to be ready.
        ...
        4. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
            ...
            ![Untitled](/products/sce/images/stable-diffusion/deploy-sdnext-7.png)
    ...
    2. Submit your prompt to the provided Access Domain Name. You will get back a json response within a few seconds. See [above](#build-and-test-your-docker-image) for how to submit the request and process the response.
        ...
        ![Untitled](/products/sce/images/stable-diffusion/deploy-sdnext-8.png)
