...
2.  (Recommended) Run the docker image locally to confirm it works as expected
    ...
    1. Drag in this image to populate the workflow.
       ...
       ![Drag in the image to populate the workflow](/guides/image-generation/images/flux_schnell_checkpoint_example.png)

    You should see something like the following:
    ![Populated workflow](/guides/image-generation/images/comfy-default-view-flux.png)
    ...
    1.  Click “Queue Prompt” to generate an image. The first image should be identical to the one we used to populate
        ...
        mine.
        ![A glass bottle with a galaxy and the planet earth inside, a glass containing white wine, a plate with mixed vegetables, and a plate with a piece of pie.](/guides/image-generation/images/comfy-flux-image-1.png)
...
```
    ...
    5. Submit the prompt to the wrapper API on port 3000, using Postman or any http request tool of your choice.
        ...
        ![Submitting the request via Postman](/guides/image-generation/images/comfy-flux-submit-prompt-1.png)
    ...
    7. Decode the base64 encoded string into your image. You can do this in a free browser tool such as https://codebeautify.org/base64-to-image-converter
        ...
        ![Decoding the returned base64 image](/guides/image-generation/images/comfy-flux-decoded-image-1.png)
...
![Untitled](/guides/image-generation/images/deploy-comfy-flux-fp8-1.png)

![Untitled](/guides/image-generation/images/deploy-comfy-flux-fp8-2.png)
...
1. Wait for the deployment to be ready.
   ...
   1. First, SaladCloud pulls your container image into our own internal high-performance cache.
      ![Untitled](/guides/image-generation/images/deploy-comfy-flux-fp8-5.png)
   1. Next, SaladCloud begins downloading the cached container image to the nodes that have been assigned to your
      workload. ![Untitled](/guides/image-generation/images/deploy-comfy-flux-fp8-6.png) This step can take tens of
   ...
   1. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
      ...
      ![Untitled](/guides/image-generation/images/deploy-comfy-flux-fp8-8.png)
...
2. Submit your prompt to the provided Access Domain Name. You will get back a json response within a few seconds. See
   ...
   ![Untitled](/guides/image-generation/images/comfy-flux-submit-prompt-2.png)
