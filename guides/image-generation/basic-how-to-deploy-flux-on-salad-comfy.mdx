...
![Deploy Flux on Salad, generated in flux](/products/sce/images/stable-diffusion/deploy-flux-5.png)
...
2.  (Recommended) Run the docker image locally to confirm it works as expected
    ...
    1. Go to [http://localhost:8188/](http://localhost:8188/) in your browser. You should see something like this:
       ...
       ![Default Comfy UI Interface](/products/sce/images/stable-diffusion/comfy-default-view.png)
    ...
    1. Drag in this image to populate the workflow.
       ...
       ![Drag in the image to populate the workflow](/products/sce/images/stable-diffusion/flux_schnell_checkpoint_example.png)

    You should see something like the following:
    ![Populated workflow](/products/sce/images/stable-diffusion/comfy-default-view-flux.png)
    ...
    1.  Click “Queue Prompt” to generate an image. The first image should be identical to the one we used to populate
        ...
        mine.
        ![A glass bottle with a galaxy and the planet earth inside, a glass containing white wine, a plate with mixed vegetables, and a plate with a piece of pie.](/products/sce/images/stable-diffusion/comfy-flux-image-1.png)
    1.  Enable Dev Mode Options via the settings menu

        ![Click the gear to open the settings menu](/products/sce/images/stable-diffusion/comfy-settings-menu-1.png)

        ![Check the box labeled "Enable Dev mode Options"](/products/sce/images/stable-diffusion/comfy-settings-menu-2.png)

        You should see a new option in the menu, “Save (API Format)”:

        ![Notice the new button labeled "Save (API Format)"](/products/sce/images/stable-diffusion/comfy-settings-menu-3.png)
...
```
    ...
    5. Submit the prompt to the wrapper API on port 3000, using Postman or any http request tool of your choice.
        ...
        ![Submitting the request via Postman](/products/sce/images/stable-diffusion/comfy-flux-submit-prompt-1.png)
    ...
    7. Decode the base64 encoded string into your image. You can do this in a free browser tool such as https://codebeautify.org/base64-to-image-converter
        ...
        ![Decoding the returned base64 image](/products/sce/images/stable-diffusion/comfy-flux-decoded-image-1.png)
...
![Untitled](/products/sce/images/stable-diffusion/deploy-comfy-flux-fp8-1.png)

![Untitled](/products/sce/images/stable-diffusion/deploy-comfy-flux-fp8-2.png)

![Untitled](/products/sce/images/stable-diffusion/deploy-comfy-3.png)
...
![Untitled](/products/sce/images/stable-diffusion/deploy-comfy-4.png)
...
1. Wait for the deployment to be ready.
   ...
   1. First, Salad pulls your container image into our own internal high-performance cache.
      ![Untitled](/products/sce/images/stable-diffusion/deploy-comfy-flux-fp8-5.png)
   1. Next, Salad begins downloading the cached container image to the nodes that have been assigned to your workload.
      ![Untitled](/products/sce/images/stable-diffusion/deploy-comfy-flux-fp8-6.png) This step can take tens of minutes
      in some cases, depending on the size of the image, and the internet speed of the individual nodes. Note that our
   ...
   1. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
      ...
      ![Untitled](/products/sce/images/stable-diffusion/deploy-comfy-flux-fp8-8.png)
...
2. Submit your prompt to the provided Access Domain Name. You will get back a json response within a few seconds. See
   ...
   ![Untitled](/products/sce/images/stable-diffusion/comfy-flux-submit-prompt-2.png)
