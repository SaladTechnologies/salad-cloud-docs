...
![Untitled](/guides/image-generation/images/sunset-base64-3.png)
...
```
    ...
    2. Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [SaladCloud Public API](/reference/saladcloud-api/container_groups/create-a-container-group)
        ...
        ![Untitled](/guides/image-generation/images/deploy-fooocus-1.png)
        ...
        ![Untitled](/guides/image-generation/images/deploy-fooocus-2.png)
        ...
        ![Untitled](/guides/image-generation/images/deploy-fooocus-3.png)
        ...
        ![Untitled](/guides/image-generation/images/deploy-fooocus-4.png)
...
## Interact with Your Deployment
    ...
    1. Wait for the deployment to be ready.
        ...
        4. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
            ...
            ![Untitled](/guides/image-generation/images/deploy-fooocus-8.png)
    ...
    2. Submit your prompt to the provided Access Domain Name. You will get back a json response within 10-20 seconds. See [above](#build-and-test-your-docker-image) for how to submit the request and process the response.
        ...
        ![Untitled](/guides/image-generation/images/deploy-fooocus-9.png)
