...
1. ComfyUI
   1. Guide: [ComfyUI](/products/sce/guides/stable-diffusion/basic-how-to-deploy-stable-diffusion-on-salad-comfy)
...
2. Automatic1111
   1. Guide: [Automatic1111](/products/sce/guides/stable-diffusion/basic-how-to-deploy-stable-diffusion-on-salad-a1111)
   1. Git Repo:
...
3. SD.Next
   1. Guide: [SD.Next](/products/sce/guides/stable-diffusion/basic-how-to-deploy-stable-diffusion-on-salad-sdnext)
...
4. Fooocus:
   1. Guide: [Fooocus](/products/sce/guides/stable-diffusion/basic-how-to-deploy-stable-diffusion-on-salad-fooocus)
...
2. **Job Queue**: This is a more resilient way to access your container group.
   ...
   1. **Fully asyncronous**: Completed jobs are not returned to the client, but instead must be fetched from the job
...
In most situations, the first request to an inference server will be signficantly slower than subsequent requests. This
