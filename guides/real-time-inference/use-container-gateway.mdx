...
<img src="/guides/real-time-inference/images/1ucg.png" />
...
[the Least Number of Connections algorithm](/products/sce/gateway/load-balancer-options#algorithms) is more effective,
...
spikes. Please check
[this link](/tutorials/high-performance-apps#implement-auto-scaling-at-the-quarter-hour-granularity) for more
information.
...
[a robust architecture](/tutorials/high-performance-apps#select-a-robust-inference-server) supporting multiple threads
...
The gateway has a [server response timeout](/products/sce/gateway/load-balancer-options#server-response-timeout) of up
...
[To improve system robustness](/tutorials/high-performance-apps#adopt-adaptive-architectures), inference servers can
...
Please review these links ([LLM](/guides/llm/llm-general#recommendation-for-production),
[image generation](/guides/image-generation/#container-gateway-or-job-queue)) thoroughly before building real-time
