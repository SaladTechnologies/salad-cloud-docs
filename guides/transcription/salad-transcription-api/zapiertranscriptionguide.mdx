...
1. **Request Zap**: This Zap will trigger when a Google Form (or any other app of your choice) is submitted, sending a
   transcription request to the Salad service.
2. **Response Zap**: This Zap will catch the response from the Salad service and send the transcription result via email
...
2. **Create a New Zap**: On the home page, click the "Create" button and select "Zaps".
   <img src="/guides/transcription/salad-transcription-api/images/zappier1.png" />
...
12. **Configure the Action:**
    1. Fill in the required fields:
       ...
       2. **URL**: Enter your Salad API endpoint URL. For example:
...
1. **Submit the Google Form**: When you submit the form with the audio file link, it triggers the Request Zap, which
   sends the transcription request to the Salad service.
