...
```json
{
  ...
  "ttps://www.facebook.com/user/videos/name-of-video/29837453749587394857/": "https://storage-api.salad.com/organizations/YOUR_ORGANIZATION_NAME/files/audio/....mp3?token=TOKEN"
}
```

- Salad Storage supports a max file size of 100MB. If the Facebook video is too long, you may need to
  [split the audio](/guides/transcription/salad-transcription-api/splitting-large-audio-files) or use a different
  storage solution.
