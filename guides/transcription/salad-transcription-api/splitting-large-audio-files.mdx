...
After running the script, your output directory should now contain your original audio clip split into compatible segments to transcribe with Salad Transcription API. It should look something like this:

<img src="/guides/transcription/salad-transcription-api/images/audio-split.png" />

You can now use these audio files to transcribe with using [Salad Transcription API.](/guides/transcription/salad-transcription-api/transcription-quick-start)
