...
By using our integrated custom LLM prompts, you can identify hate speech, with confidence ratings and category, in your transcriptions. To use this, you just need to add the `custom_prompt` input parameter to your transcription request.
...
In this script, we're telling the LLM to look for and identify any hate speech in the transcription content and categorize it. It will be
