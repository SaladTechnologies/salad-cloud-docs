...
description:
  'Get started with Salad Transcription API here. This step by step guide will walk you through setting up your Salad
  Portal account and running your first Transcription API job. Alternatively, [Fork this PostMan.com
