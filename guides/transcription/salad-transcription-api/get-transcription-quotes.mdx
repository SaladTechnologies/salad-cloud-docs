...
By using our integrated custom LLM prompts, you can extract the important quotes from your transcriptions, along with
the timestamps. To use this, you just need to add the `custom_prompt` input parameter to your transcription request.
