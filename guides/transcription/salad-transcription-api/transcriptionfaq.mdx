---
title: 'SaladCloud Transcription FAQ'
---

**_Does SaladCloud Transcription have a web or app-based mobile experience?_**

No, SaladCloud Transcription is an API product. Learn more about our API documentation,
...
transcription capabilities, which are part of your own SaaS service, as long as it is not reselling SaladCloud
Transcription.
...
SaladCloud Transcription supports up to 3GB media files. Media files that are longer than 2.5 hours in duration will
need to be split. If you you require support for larger files, contact our
...
SaladCloud Transcription transcribes, on average, 8x faster than the duration of your media file. If diarization and
time codes are enabled, it drops to 4x faster as multiple passes are required.
