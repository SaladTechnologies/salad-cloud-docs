...
- Next, you’ll add the URL to the file to transcribe into the URL object. Make sure the file length is less than 2.5
  ...
  [Salad Simple Storage Service](/products/s4/salad-simple-storage-service#upload-a-file)
...
available [here](/guides/transcription/salad-transcription-api/transcription-quick-start#step-2-set-input-parameters).
