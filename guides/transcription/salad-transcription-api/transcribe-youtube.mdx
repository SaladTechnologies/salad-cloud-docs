...
[Salad Simple Storage Service](/products/s4/salad-simple-storage-service/), and use the resulting link with the API.
...
You can find detailed instructions on how to send requests to the Salad Transcription API in the official documentation:
