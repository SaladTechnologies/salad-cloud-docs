...
description:
  'Get started with SaladCloud Transcription API here. This step by step guide will walk you through setting up your
  Salad Portal account and running your first Transcription API job. Alternatively, [Fork this PostMan.com
...
<img
  ...
  alt="Access SaladCloud Transcription API"
/>
