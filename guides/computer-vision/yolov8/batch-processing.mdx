...
object detection solution. SaladCloud has a very user-friendly interface as well as an API for deployment. Let’s deploy
our solution using SaladCloud portal.
