...
4. **Check resources**:
   - Open your resource group in azure and check the resources. You should see something similar to this:
     <img src="/guides/computer-vision/yolov8/images/yolov8-azure-resource-group-preview.png" />
...
<img src="/guides/computer-vision/yolov8/images/yolov8-youtube-metadata.png" />
...
2. **Pick the Image Source:** In our case we are using a private Azure Container Registry. Click Edit next to Image
   ...
   <img src="/guides/computer-vision/yolov8/images/azure-container-registry-repositories.png" />
   ...
   <img src="/guides/computer-vision/yolov8/images/yolov8-azure-container-image-name.png" />
...
5. **Environment variables:** This is where we need to add our environment variables we went through above. Specify them
   ...
   <img src="/guides/computer-vision/yolov8/images/environment-variables-portal.png" />
...
<img src="/guides/computer-vision/yolov8/images/yolov8-batch-youtube-submit.png" />
