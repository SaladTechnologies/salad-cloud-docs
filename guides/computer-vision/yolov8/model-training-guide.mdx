...
deploying a pre-trained YOLOv8 model using SaladCloud's cloud infrastructure. During that journey we did real-time
object tracking and analysis. In the landscape of AI and machine learning, the ability to train custom models for
specific tasks opens up a world of possibilities. And now, we're taking a step further: training a custom YOLO (You Only
Look Once) model using SaladCloud .
...
2. **Cost Analysis**: Given that training is a resource-heavy task, understanding the financial implications is crucial.
   We will compare the costs of training each model on SaladCloud's cloud platform, offering a clear perspective on the
...
<img src="/products/sce/images/8a17a88-Screenshot_2023-11-26_144806.png" />
...
<img src="/products/sce/images/093038e-Screenshot_2023-11-26_155043.png" />

Solution Architecture:

<img src="/products/sce/images/b6dfaeb-Training_Architecture.drawio.png" />
...
<img src="/products/sce/images/7ba7f70-Screenshot_2023-11-26_165430.png" />
...
<img src="/products/sce/images/529d48a-workflow.drawio.png" />
...
<img src="/products/sce/images/6f5a5e3-confusion_matrix_normalized.png" />

We can see that some of the labels are being detected pretty good, but a few are positively detected in less than half
of the scenarios.

<img src="/products/sce/images/d5c6c5c-results.png" />

Here we can see what the labels on a picture are and what we predicted with our trained model:

<img src="/products/sce/images/16f170b-val_batch0_labels.jpg" />

<img src="/products/sce/images/e29a1f3-val_batch0_pred.jpg" />
...
<img src="/products/sce/images/69e0885-confusion_matrix_normalized_1.png" />

We can see that the model performs better

<img src="/products/sce/images/7caac82-results.png" />

<img src="/products/sce/images/4ebc600-val_batch0_pred.jpg" />
...
<img src="/products/sce/images/1402547-confusion_matrix_normalized.png" />

<img src="/products/sce/images/d8d25f3-results.png" />

<img src="/products/sce/images/ef883c8-val_batch0_pred.jpg" />
...
<img src="/products/sce/images/bd1dfb4-2023-11-29-16-00-34.gif" />
...
cost-effectiveness of advanced model training using SaladCloud's cloud environment. Training custom computer vision
models has never been that accessible.
