...
<img src="/guides/kubernetes-integration/images/k8s-service.png" />

## Solution to Scenario 1

This is a widely adopted scenario where client applications and GPU nodes are decoupled, offering enhanced scalability
and flexibility, and greater resilience to traffic spikes and node failures. Most existing solutions and applications,
including [real-time inference](/guides/real-time-inference/build-redis-queue),
...
automatically written back to the pod's annotations for easy access (**currently not supported in v0.2.1**). However,
