...
<img src="/guides/kubernetes-integration/images/k8s-install1.png" />
...
<img src="/guides/kubernetes-integration/images/k8s-install2.png" />
...
Then run the **helm template** command to pull the chart (0.2.1) hosted on the OCI registry at GitHub Container Registry
(GHCR) and render the chart with the above environment variables:

```
helm template scnode3-dryrun oci://ghcr.io/saladtechnologies/virtual-kubelet-saladcloud-chart --version 0.2.1 \
  --create-namespace \
...
Now, install the chart using the **helm install** command:

```
helm install scnode3 oci://ghcr.io/saladtechnologies/virtual-kubelet-saladcloud-chart --version 0.2.1 \
  --create-namespace \
  --namespace salad-cloud \
  --set salad.apiKey=$SALAD_API_KEY \
  --set salad.organizationName=$SALAD_ORGANIZATION_NAME \
...
<img src="/guides/kubernetes-integration/images/k8s-install3.png" />
...
<img src="/guides/kubernetes-integration/images/k8s-install-scnode3.png" />

<img src="/guides/kubernetes-integration/images/k8s-troubleshooting.png" />

<img src="/guides/kubernetes-integration/images/k8s-install-logs1.png" />
...
<img src="/guides/kubernetes-integration/images/k8s-uninstall.png" />

Now, remove the node from the Kubernetes cluster:

<img src="/guides/kubernetes-integration/images/k8s-delete-node.png" />
