...
<img src="/guides/kubernetes-integration/images/k8s-scheduling.png" />
   ...
   Spec:
     ...
     containers:
       - image: docker.io/saladtechnologies/misc:0.0.2-test
         ...
         livenessProbe:
           exec:
             command: ["curl", "--fail", "http://localhost:8888/hc"]
...
| 7   | Networking (Container Gateway)                      | Use salad.com/newokring-XXX under the spec.template.metadata.annotations.                                                                                                                                                                                                             |
...
deployment in a future version (not supported in v0.2.1). In the meantime, alternative access methods are available for
these virtual pods—please refer to [the service access guide](/guides/kubernetes-integration/service-access) for
details.
...
[the source code](https://github.com/SaladTechnologies/virtual-kubelet-saladcloud/blob/main/internal/provider/provider.go)
...
<img src="/guides/kubernetes-integration/images/k8s-rolling1.png" />
...
<img src="/guides/kubernetes-integration/images/k8s-rolling2.png" />
...
<img src="/guides/kubernetes-integration/images/k8s-rolling3.png" />
