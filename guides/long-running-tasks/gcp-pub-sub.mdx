...
- [Get Container Group](/reference/saladcloud-api/container_groups/get-a-container-group)
- [Start Container Group](/reference/saladcloud-api/container_groups/start-a-container-group)
- [Stop Container Group](/reference/saladcloud-api/container_groups/stop-a-container-group)
- [Set Replicas](/reference/saladcloud-api/container_groups/update-a-container-group)
