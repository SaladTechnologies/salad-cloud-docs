...
- [Get Container Group](https://docs.salad.com/reference/saladcloud-api/container_groups/get-a-container-group)
- [Start Container Group](https://docs.salad.com/reference/saladcloud-api/container_groups/start-a-container-group)
- [Stop Container Group](https://docs.salad.com/reference/saladcloud-api/container_groups/stop-a-container-group)
- [Set Replicas](https://docs.salad.com/reference/saladcloud-api/container_groups/update-a-container-group)
