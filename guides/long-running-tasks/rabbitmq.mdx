...
<Frame caption="RabbitMQ Management Interface showing a full queue">
  <img
    src="/guides/long-running-tasks/images/rabbitmq-10k-messages.png"
...
<Frame caption="Creating a new Container Group">
  <img src="/guides/long-running-tasks/images/rabbitmq-cg-create-1.png" alt="Creating a new Container Group" />
</Frame>
...
<Frame caption="Setting the hardware requirements">
  <img src="/guides/long-running-tasks/images/rabbitmq-cg-create-2.png" alt="Setting the hardware requirements" />
</Frame>
...
<Frame caption="Setting the job priority and storage requirements">
  <img
    src="/guides/long-running-tasks/images/rabbitmq-cg-create-3.png"
...
<Frame caption="Preparing the container">
  <img src="/guides/long-running-tasks/images/rabbitmq-cg-preparing.png" alt="Preparing the container" />
</Frame>
...
<Frame caption="Downloading the images to the replicas">
  <img src="/guides/long-running-tasks/images/rabbitmq-cg-deploying.png" alt="Downloading the images to the replicas" />
</Frame>

After a minute or so, we should see our instances up and running.

<Frame caption="Instances up and running">
  <img src="/guides/long-running-tasks/images/rabbitmq-cg-running.png" alt="Instances up and running" />
</Frame>
...
<Frame caption="In-flight messages in our queue">
  <img src="/guides/long-running-tasks/images/rabbitmq-messages-in-flight.png" alt="In-flight messages in the queue" />
</Frame>
...
<Frame caption="Creating a new Worker">
  <img src="/guides/long-running-tasks/images/rabbitmq-workers-create.png" alt="Creating a new Worker" />
</Frame>
...
[SaladCloud API](https://docs.salad.com/reference/saladcloud-api/container_groups/get-a-container-group).
...
<Frame caption="Disabling the domains and routes, and setting the environment variables">
  <img src="/guides/long-running-tasks/images/rabbitmq-workers-settings.png" alt="Disabling the domains and routes" />
</Frame>
...
<Frame caption="Setting the trigger to run every 5 minutes">
  <img
    src="/guides/long-running-tasks/images/rabbitmq-workers-trigger.png"
