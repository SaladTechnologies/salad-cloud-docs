...
<Frame caption="The SQS Console showing 10000 messages in the queue">
  <img
    src="/guides/long-running-tasks/images/sqs-10k-messages.png"
    alt="The SQS Console showing 10000 messages in the queue"
  />
</Frame>

## Dockerizing the Worker Application
...
<Frame caption="Creating a new Container Group">
  <img src="/guides/long-running-tasks/images/sqs-cg-create-1.png" alt="Creating a new Container Group" />
</Frame>
...
<Frame caption="Setting the hardware requirements">
  <img src="/guides/long-running-tasks/images/sqs-cg-create-2.png" alt="Setting the hardware requirements" />
</Frame>
...
<Frame caption="Setting the job priority and storage requirements">
  <img
    src="/guides/long-running-tasks/images/sqs-cg-create-3.png"
...
<Frame caption="Preparing the container">
  <img src="/guides/long-running-tasks/images/sqs-cg-preparing.png" alt="Preparing the container" />
</Frame>
...
<Frame caption="Downloading the images to the replicas">
  <img src="/guides/long-running-tasks/images/sqs-cg-deploying.png" alt="Downloading the images to the replicas" />
</Frame>

After a minute or so, we should see our instances up and running.

<Frame caption="Instances up and running">
  <img src="/guides/long-running-tasks/images/sqs-cg-running.png" alt="Instances up and running" />
</Frame>
...
<Frame caption="In-flight messages in the SQS queue">
  <img src="/guides/long-running-tasks/images/sqs-messages-in-flight.png" alt="In-flight messages in the SQS queue" />
</Frame>
...
<Frame caption="Creating a new Lambda function">
  <img src="/guides/long-running-tasks/images/sqs-lambda-console.png" alt="Creating a new Lambda function" />
</Frame>
...
<Frame caption="Setting the runtime and architecture">
  <img src="/guides/long-running-tasks/images/sqs-lambda-create.png" alt="Setting the runtime and architecture" />
</Frame>

Once your function has been created, you'll land on the function overview page.

<Frame caption="The function overview page">
  <img src="/guides/long-running-tasks/images/sqs-lambda-editor.png" alt="The function overview page" />
</Frame>
...
<Frame caption="Find The Execution Role">
  <img src="/guides/long-running-tasks/images/sqs-lambda-find-execution-role.png" alt="The ARN of the execution role" />
</Frame>
...
<Frame caption="The ARN of the execution role">
  <img src="/guides/long-running-tasks/images/sqs-lambda-find-role-arn.png" alt="The ARN of the execution role" />
</Frame>
...
<Frame caption="The Queue Policies tab">
  <img src="/guides/long-running-tasks/images/sqs-lambda-permissions.png" alt="The Queue Policies tab" />
</Frame>
...
```json
{
  ...
  "Principal": {
    "AWS": ["arn:aws:iam::523358417554:role/service-role/lrt-autoscaling-role-liaizhxl"]
  }
}
```
...
<Frame caption="Testing the Lambda">
  <img src="/guides/long-running-tasks/images/sqs-lambda-deploy-and-test.png" alt="Testing the Lambda" />
</Frame>
...
<Frame caption="Creating a new CloudWatch Event">
  <img src="/guides/long-running-tasks/images/sqs-lambda-trigger.png" alt="Creating a new CloudWatch Event" />
</Frame>

<Frame caption="Setting the schedule">
  <img src="/guides/long-running-tasks/images/sqs-lambda-configure-trigger.png" alt="Setting the schedule" />
</Frame>
