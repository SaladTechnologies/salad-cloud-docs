...
that it is failing to set the [deletion cost](/products/sce/container-groups/imds/instance-deletion-cost), because we
...
<Frame caption="Creating a new Container Group">
  <img src="/guides/long-running-tasks/images/kelpie-cg-create-1.png" alt="Creating a new Container Group" />
</Frame>
...
<Frame caption="Preparing the container">
  <img src="/guides/long-running-tasks/images/kelpie-cg-preparing.png" alt="Preparing the container" />
</Frame>

Once it's prepared, it will start allocating replicas, and downloading the container image to those replicas.

<Frame caption="Alloocating replicas">
  <img src="/guides/long-running-tasks/images/kelpie-cg-allocating.png" alt="Allocating replicas" />
</Frame>
Once the replicas are allocated, they will start downloading the container image from our internal cache. This can take a
few minutes, depending on the size of the image.

<Frame caption="Downloading the images to the replicas">
  <img src="/guides/long-running-tasks/images/kelpie-cg-downloading.png" alt="Downloading the images to the replicas" />
</Frame>

After a minute or so, we should see our instances up and running.

<Frame caption="Instances up and running">
  <img src="/guides/long-running-tasks/images/kelpie-cg-running.png" alt="Instances up and running" />
</Frame>
...
<Frame caption="Kelpie worker hard at work">
  <img src="/guides/long-running-tasks/images/kelpie-logs.png" alt="Kelpie worker hard at work" />
</Frame>
