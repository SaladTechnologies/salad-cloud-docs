...
[Stable Diffusion 3.5 Large](https://huggingface.co/stabilityai/stable-diffusion-3.5-large) image generation model by
...
![](/products/recipes/images/sd35-large-image-1.png)

![](/products/recipes/images/sd35-large-image-2.png)

![](/products/recipes/images/sd35-large-image-3.png)

![](/products/recipes/images/sd35-large-image-4.png)
...
![](/products/recipes/images/deploy-sd35-large-1.png)

### Visit The Docs

Once at least one instance is running, you can navigate to the `/docs` endpoint at the Access Domain Name provided in
the portal. In the above example that URL is `https://eggplant-egg-ubndgswr8wflky92.salad.cloud/docs` . You’ll see the
swagger documentation that looks something like this:

![](/products/recipes/images/sd35-large-docs-1.png)
