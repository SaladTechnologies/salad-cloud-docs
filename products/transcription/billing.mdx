...
Here are examples to illustrate how charges are calculated:

- **10 minutes**: `10 minutes = 0.1667 hours → rounded to 0.17 hours`

- **5 minutes**: `5 minutes = 0.0833 hours → rounded to 0.08 hours`

- **2 minutes**: `2 minutes = 0.0333 hours → rounded to 0.03 hours`

- **30 seconds**: `30 seconds = 0.0083 hours → rounded to 0.01 hours`
