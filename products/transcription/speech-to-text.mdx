...
description: 'Transform spoken words into accurate text with Salad Transcription API’s powerful speech-to-text capabilities.'
---
...
Unlock the content within your audio and video files using **Salad Transcription API’s Speech-to-Text** feature. Our advanced technology converts spoken language into written text with high accuracy, supporting a wide range of languages and delivering transcriptions that are ready for use in various applications.
...
- **Transcribe in 97 Languages**: From widely spoken languages like English and Spanish to regional languages, we support a vast array to meet your needs.
...
- **Domain-Specific Terms, names and phrases**: Improve accuracy by adding industry-specific terminology, names and entities (in preview)
...
Check our [technical documentation](https://docs.salad.com/guides/transcription/salad-transcription-api/speech-to-text)
---

Elevate your content accessibility and efficiency with **Salad Transcription API’s Speech-to-Text** capabilities. Transform spoken words into actionable text today.
