...
5. Provide a name and description for the service account, grant it `Artfact Resgistry Reader access` to your project, and proceed to
   create the account. *(Note: Most read/write permissions should work, except Basic - Browser which does **NOT** work)*
...
<img src="/products/sce/container-groups/registries/images/configure-gar.png" />
