...
the service dropdown option, choose "Google Container Registry" and provide the following information:

- Image name (example: `us.gcr.io/{my-app}/{my-container-image}:{version/latest}`)
- JSON Key (generated or downloaded in step 1)

<img src="/products/sce/container-groups/registries/images/configure-gcr.png" />
