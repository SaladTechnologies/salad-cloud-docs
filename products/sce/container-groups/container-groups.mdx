...
- **[Container Registry and Image](/products/sce/container-groups/registries/container-registries)**: Specify the
...
<img src="/products/sce/container-groups/images/portal-select-hardware.png" />
...
- **[Environment Variables](/products/sce/container-groups/environment-variables)**: Define environment variables to
  ...
  ![](/products/sce/container-groups/images/portal-environment-variables-key-value-edit.png)
  ![](/products/sce/container-groups/images/portal-environment-variables-bulk-edit.png)
- **[Command](/products/sce/container-groups/specifying-a-command)**: Specify the command to run when the container
...
- **[Readiness Probe](/products/sce/container-groups/health-probes/readiness-probes)**: Set up a readiness probe to
...
- **[External Logging Service](/products/sce/container-groups/external-logging/external-logging)**: Optionally configure
  an external logging service for container logs. Recommended for production deployments.

<img src="/products/sce/container-groups/images/portal-monitoring-config.png" />
...
<img src="/products/sce/container-groups/images/portal-container-group-actions.png" />
