...
[startup probe](/products/sce/container-groups/health-probes/startup-probes), but not completed its
[readiness probe](/products/sce/container-groups/health-probes/readiness-probes), we'll see this:
