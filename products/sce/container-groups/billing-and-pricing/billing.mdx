...
SaladCloud only accepts valid credit cards as a payment method through the SaladCloud portal. Debit and prepaid 
cards are not accepted. For additional payment methods, please reach out to [sales@salad.com](mailto:sales@salad.com).
