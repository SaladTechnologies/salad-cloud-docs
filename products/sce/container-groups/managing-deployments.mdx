...
- You can edit the [Health Check Probes](/products/sce/container-groups/health-probes/health-probes) (Startup, and Liveness).
...
- You can modify or enable/disable the [External Logging](/products/sce/container-groups/external-logging/external-logging) Services.
