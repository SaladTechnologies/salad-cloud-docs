...
- Date created
- [Deployment status (Preparing, Stopped, Deploying, Running, Failed)](/products/sce/container-groups/deployment-lifecycle)
- Replicas running
- Version
...
<img src="/products/sce/container-groups/images/portal-list-container-groups.png" />
...
<img src="/products/sce/container-groups/images/portal-view-container-group.png" />
...
- You can modify hardware resource requirements, such as the number of vCPUs, Memory (RAM), GPUs, and
  [Disk Space](/products/sce/container-groups/disk-space).
- You can edit the [Health Check Probes](/products/sce/container-groups/health-probes/health-probes) (Startup, and
  Liveness).
- You can edit the [Command](/products/sce/container-groups/specifying-a-command).
...
- You can modify or enable/disable the
  [External Logging](/products/sce/container-groups/external-logging/external-logging) Services.
- You can edit the [Environment Variables](/products/sce/container-groups/environment-variables).
...
<img src="/products/sce/container-groups/images/portal-container-instance-actions.png" />

<img src="/products/sce/container-groups/images/portal-container-instance-version.png" />
