...
SaladCloud Container Engine (SCE) supports four probe protocols: `exec`,` TCP`, `gRPC`, and` HTTP/1.X`. These protocols
...
<img src="/products/sce/container-groups/health-probes/images/startup-success.png" />

### Failed Startup Probe

<img src="/products/sce/container-groups/health-probes/images/startup-failure.png" />
...
<img src="/products/sce/container-groups/health-probes/images/portal-edit-probes.png" />
...
<img src="/products/sce/container-groups/health-probes/images/startup-exec-edit-command.png" />
...
<img src="/products/sce/container-groups/health-probes/images/startup-exec-config-command.png" />
