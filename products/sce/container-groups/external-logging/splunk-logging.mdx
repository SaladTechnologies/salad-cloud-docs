...
6. Click on “Next”, will be prompted with “Token Value” and “Start searching” option.
   <img src="/products/sce/container-groups/external-logging/images/splunk-get-credentials.png" />
...
2. In the sidebar appears at right, click on "**Splunk**" under the option of “Select a Container Logging Service”.
   ...
   <img src="/products/sce/container-groups/external-logging/images/select-and-configure-splunk.png" />
