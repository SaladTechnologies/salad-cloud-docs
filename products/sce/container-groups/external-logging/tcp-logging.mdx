...
<img src="/products/sce/container-groups/external-logging/images/select-and-configure-tcp.png" />

Then, start the container group and, on your TCP endpoint, you should see streaming logs from your containers!

<img src="/products/sce/container-groups/external-logging/images/tcp-logs.png" />
