...
- Date created
- [Deployment status (Preparing, Stopped, Deploying, Running, Failed)](/products/sce/deployment-lifecycle)
- Replicas running
- Version
...
<img src="/products/sce/images/5ef427e-image.png" />
...
<img src="/products/sce/images/92a596a-image.png" />
...
- You can modify hardware resource requirements, such as the number of vCPUs, Memory (RAM), GPUs, and
  [Disk Space](/products/sce/disk-space).
- You can edit the [Health Check Probes](/products/sce/health-probes) (Startup, and Liveness).
- You can edit the [Command](/products/sce/specifying-a-command).
- If enabled, you can edit the [Container Gateway](/products/sce/networking) Port. Note: the edit Container Group
  functionality doesn't allow for the Container Gateway to be disabled, enabled, or authentication to be changed.
- You can modify or enable/disable the [External Logging](/products/sce/external-logging) Services.
- You can edit the [Environment Variables](/products/sce/environment-variables).
...
<img src="/products/sce/images/271b376-image.png" />

<img src="/products/sce/images/7bd5e3f-image.png" />
