...
the container group they are a part of. While deploying on Salad is usually quick, it can occasionally take 20 minutes
or more to get your containers up and running. **You are only charged for an instance once it reaches Running state.**
