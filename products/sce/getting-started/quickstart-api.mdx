...
[Create a Container Group](/reference/saladcloud-api/container_groups/create-a-container-group) endpoint.
...
_Note: you can also test it on our [API reference page](/reference/saladcloud-api/organizations/get-gpu-classes)_
...
[public API ](/reference/saladcloud-api/container_groups/start-a-container-group) itself_
