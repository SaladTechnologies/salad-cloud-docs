...
- **How does latency work on Salad?**
  ...
  - Many companies run production workloads on SaladCloud with acceptable latency times. One of Salad’s largest users is
    an AI image generation tool that serves millions of users. Our team can work with you on the right architecture to
...
- **What is the expected uptime on SaladCloud?**
  ...
  - Salad’s uptime is fundamentally different from other providers. While individual nodes on SaladCloud have a
