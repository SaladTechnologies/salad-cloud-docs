...
[Learn more about how SaladCloud works](/products/sce/getting-started/about), including how we ensure security and
privacy for both device owners and container operators.
...
<CardGroup cols={1}>
  <Card title="SaladCloud Container Engine (SCE)" icon="docker" href="/products/sce">
    ...
    [billed](/products/sce/container-groups/billing-and-pricing/billing) by the amount of time any workload replica is running.
  </Card>
