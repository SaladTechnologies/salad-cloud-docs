...
<CardGroup cols={1}>
  ...
  <Card title="Recipes" icon="rocket" href="/products/recipes">
    Ready-to-deploy, easy-to-customize applications for popular use cases. These are pre-configured container groups
    that run on the Container Engine, and are [billed as normal container groups](/products/sce/billing.mdx).
  </Card>
