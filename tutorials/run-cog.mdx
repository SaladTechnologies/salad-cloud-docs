...
The provided [command and its arguments](https://docs.salad.com/products/sce/container-groups/specifying-a-command) override both the
...
[the HTTP/1.X probe](https://docs.salad.com/products/sce/container-groups/health-probes/health-probes#http-1-x-protocol) checks the health of an HTTP
...
Because the [command and its arguments](https://docs.salad.com/products/sce/container-groups/specifying-a-command) override both the
...
The Readiness Probe with [the protocol - exec](https://docs.salad.com/products/sce/container-groups/health-probes/health-probes#exec-protocol), will
