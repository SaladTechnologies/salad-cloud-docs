...
If you are utilising additional features offered by Azure to translate the text to another language, or summarize
...
Utilising our LLM translation services is similar to the direct to English translation, but uses a different input
