...
Migrating from Azure Batch Transcription to Salad Transcription API will require only a simple API call modification. Depending on which features you are using, you may also be able to reduce the number of API calls required, as Salad Transcription API is able to handle multiple steps in one. 



|  | SaladCloud Transcription | Azure Batch Transcription |
| ----- | ------------------------ | ------------------------- |
...
If you are utilising additional features offered by Azure to translate the text to another language, or summarize intent, you can integrate these features into the same API call with Salad Transcription API. 
...
```
{
   ...
   "output":{
      "url":"https://storage-api.salad.com/organizations/salad/files/transcription/73b2ee75-664e-4332-a853-9210dde5c5fd?token=ac34664a-088d-4c72-b53c-b1199cfbf538",
