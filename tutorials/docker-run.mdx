...
[the Image Source](/products/sce/container-groups/registries/container-registries). If the container image is from a
...
[update the image source](/products/sce/container-groups/managing-deployments#editing-your-container-group-deployment)
...
group, you can select multiple GPU types at a priority level [(Batch/Low/Medium/High)](/products/sce/container-groups/billing-and-pricing/priority-pricing),
...
[Health probes](/products/sce/container-groups/health-probes/health-probes) offer an automated mechanism to initiate specific actions based on the
...
[Readiness probes](/products/sce/container-groups/health-probes/readiness-probes) are essential when deploying a container gateway, as
...
You can also use the [exec protocol](/products/sce/container-groups/health-probes/health-probes#exec-protocol) to create a custom script for the
readiness probe.
