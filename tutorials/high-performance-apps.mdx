...
[the guide](/tutorials/high-performance-storage-solutions)
...
building a custom Redis-based real-time queue by following [this guide](/guides/real-time-inference/build-redis-queue).
