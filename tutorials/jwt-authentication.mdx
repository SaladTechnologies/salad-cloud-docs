...
<img src="/tutorials/images/jwt_auth/jwt_uc1.png" />
...
<img src="/tutorials/images/jwt_auth/jwt_uc2.png" />
...
<img src="/tutorials/images/jwt_auth/jwt_jwks.png" />
...
The [SaladCloud Instance Metadata Service](/products/sce/container-groups/imds/introduction) (IMDS) enables applications
...
[the guide](/products/sce/container-groups/imds/obtaining-an-imds-jwt).
...
<img src="/tutorials/images/jwt_auth/jwt_1.png" />
...
<img src="/tutorials/images/jwt_auth/jwt_2.png" />
...
<img src="/tutorials/images/jwt_auth/jwt_3.png" />
...
# Should call the IMDS once every 2~3 minutes and use the returned JWT for subsequent requests.
jwt_token = get_jwt()

# Include the JWT in the HTTP Authorization header.
headers = { "Authorization": f"Bearer {jwt_token}", "Content-Type": "application/json" }

# The external service endpoint
...
def validate_jwt(token, jwks_uri, audience_id):
   try:
       ...
       # Should fetch the JWKS periodically (e.g., daily), rather than on every validation.
...
The application successfully sends the job result to the external service using the JWT.

In the identity broker scenario, the application can now retrieve real credentials for accessing public cloud services,
such as job queues, databases, and storage, and securely store them in memory.

<img src="/tutorials/images/jwt_auth/jwt_5.png" />
...
For the identity broker, it can create and return the temporary credentials to applications, such as API keys, access
tokens, or username/passwords.

<img src="/tutorials/images/jwt_auth/jwt_6.png" />
