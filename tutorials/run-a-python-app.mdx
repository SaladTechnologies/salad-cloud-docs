...
[supported container registries](/products/sce/container-groups/registries/container-registries), but for this guide we will use Docker Hub.
...
[Deployment Guide](/products/sce/container-groups/container-groups)
