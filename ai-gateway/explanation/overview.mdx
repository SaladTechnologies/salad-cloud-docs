...
Salad AI Gateway uses **pay-per-token billing** at the
[published input and output token rates](/ai-gateway/reference/pricing), with no concurrency limit. Usage draws from
your organization's SaladCloud credit balance.
