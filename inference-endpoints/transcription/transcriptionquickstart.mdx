...
<img src="/inference-endpoints/images/create_account.png" alt="Create Salad Account" />
...
<img src="/inference-endpoints/images/projects.png" alt="Create Salad Organization" />
### Get Transcription API URL

*Then,* click on *Inference Endpoints* in the left-hand nav and open up the Transcription API.
<img src="/inference-endpoints/images/managed_services.png" alt="Access Salad Transcription API" />

Copy your Transcription API URL
<img src="/inference-endpoints/images/cc_page.png" alt="Copy Transcription API URL" />
