...
- **Integrate the API**: Use our flexible
  [instructions](/transcription/tutorials/transcription-quick-start) to integrate transcription
...
- **Billing**: Understand how charges are [calculated](/transcription/explanation/billing) for the transcription services
