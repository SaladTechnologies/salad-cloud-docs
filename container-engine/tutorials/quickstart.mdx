...
Refer to the [probe documentation](/container-engine/explanation/health-probes/health-probes) for full details.
...
- [Storage](/container-engine/tutorials/performance/high-performance-storage-solutions) and
  [checkpointing](/container-engine/explanation/long-running-tasks/solution-overview)
- [External logging](/container-engine/explanation/core-concepts/external-logging)
