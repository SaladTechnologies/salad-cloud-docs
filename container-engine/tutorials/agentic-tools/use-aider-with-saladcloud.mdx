...
<Tabs>
  ...
  <Tab title="Self-Hosted on SaladCloud">
    ...
    - [qwen3.5-9b-llama-cpp](/container-engine/reference/recipes/qwen3.6-9b-llama-cpp) — Optimized for Qwen3.5 9B model.
...
best with at least **16384 tokens**, ideally **32768** or higher. Our preconfigured Qwen 3.6-35B-A3B recipe already has
optimal settings.
