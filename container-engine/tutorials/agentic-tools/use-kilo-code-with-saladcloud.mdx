...
Kilo Code pairs well with SaladCloud because:

- **Custom header support** - Kilo Code has a dedicated Custom Headers field, so you can pass `Salad-Api-Key` for
  authenticated SaladCloud deployments without any workarounds
