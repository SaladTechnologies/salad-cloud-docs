...
<Tabs>
  <Tab title="Salad AI Gateway">
    ...
    | `qwen3.5-35b-a3b` | Qwen 3.5 35B-A3B - cost-efficient agentic tasks and reasoning                   |
  ...
  <Tab title="Self-Hosted on SaladCloud">
    ...
    - Select an LLM recipe. The llama.cpp [Qwen3.6-35B-A3B](/container-engine/reference/recipes/qwen3.6-35b-a3b-llama-cpp)
...
<Tabs>
  <Tab title="Salad AI Gateway">
    ...
    Use your organization-specific AI Gateway key in `apiKey`, not your account API key. No custom headers are needed.
...
For tasks that require complex instruction following and multi-step reasoning the Qwen 3.6-35B-A3B model provides
