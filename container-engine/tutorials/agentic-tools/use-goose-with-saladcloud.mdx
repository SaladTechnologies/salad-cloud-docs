...
<Tabs>
  <Tab title="Salad AI Gateway">
    ...
    **Provider Type**: OpenAI Compatible - **Display Name**: `SaladCloud AI Gateway` - **API URL**:
    `https://ai.salad.cloud:40404/v1/` - **API Base Path**: leave blank - Under **Authentication**, select **This
    provider requires API Key** and enter your Salad API key - **Available Models**: e.g. `qwen3.5-35b-a3b, qwen3.5-27b,
  ...
  <Tab title="Self-Hosted on SaladCloud">
    ...
    **Provider Type**: OpenAI Compatible - **Display Name**: a name for the provider (e.g., `SaladCloud`) - **API URL**:
    ...
    Models**: your model name (e.g., `qwen3.5-35b-a3b`) - **Custom Headers**: add `Salad-Api-Key` with your SaladCloud
