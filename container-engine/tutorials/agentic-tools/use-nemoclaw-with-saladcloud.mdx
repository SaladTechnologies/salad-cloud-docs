...
<Tabs>
  <Tab title="Salad AI Gateway">
    AI Gateway uses standard Bearer token authentication. Enter your organization-specific AI Gateway key when the
    onboarding wizard prompts for an API key, not your account API key. No custom headers are needed.
  </Tab>
  <Tab title="Self-Hosted on SaladCloud">
...
<Tabs>
  <Tab title="Salad AI Gateway">
    - **Endpoint URL**: `https://ai.salad.cloud/v1` - **API key**: your organization-specific AI Gateway API key -
    **Model name**: e.g. `qwen3.6-35b-a3b`
  </Tab>
  <Tab title="Self-Hosted on SaladCloud">
