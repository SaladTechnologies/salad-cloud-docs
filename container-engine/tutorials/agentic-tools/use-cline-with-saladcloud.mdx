...
- [qwen3.5-35B-A3B](/container-engine/reference/recipes/qwen3.5-35b-a3b) — A powerful Mixture of Experts model optimized
  for instruction-following tasks, ideal for agentic use cases.
