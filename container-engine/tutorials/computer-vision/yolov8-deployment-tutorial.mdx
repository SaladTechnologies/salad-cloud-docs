...
sidebarTitle: 'YOLOv8 Deployment'
description:
...
<img src="/container-engine/images/yolov8-reference-architecture.png" />
...
<img src="/container-engine/images/yolov8-server-start.png" />
...
<img src="/container-engine/images/yolov8-swagger-start.png" />

To stop the process execute the stop endpoint

<img src="/container-engine/images/yolov8-swagger-stop.png" />
...
| **Salad** | 4 vCores, 16GB RAM        | $0.036        | Equivalent to Azure's general compute     |

#### Percentage Cost Difference for General Compute

- **SaladCloud is approximately 81% cheaper than Azure for general compute configurations.**
...
| **Salad** | RTX 4080 (16 GB), High priority          | $0.230        | SaladCloud's equivalent GPU offering |

#### Percentage Cost Difference for GPU Compute

- **SaladCloud is approximately 81% cheaper than Azure for similar GPU configurations.**

<Note>
  Prices are approximate, exclude applicable taxes, and are subject to change. Check
  [salad.com/pricing](https://salad.com/pricing) for current rates.
</Note>
