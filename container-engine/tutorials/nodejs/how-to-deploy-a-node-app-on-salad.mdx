---
title: 'How to deploy a Node App on SaladCloud'
---
...
[Salad Container Engine (SCE)](/products/sce/introduction)

## **Prerequisites**

- A Node.js app that you have developed and tested locally
- A [Salad Container Engine(SCE) account](/products/quickstart)
