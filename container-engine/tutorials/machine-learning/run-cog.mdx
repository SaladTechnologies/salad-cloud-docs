...
[the HTTP/1.X probe](/container-engine/explanation/infrastructure-platform/health-probes#http-1-x-protocol) checks the health of
...
The Readiness Probe with [the protocol - exec](/container-engine/explanation/infrastructure-platform/health-probes#exec-protocol),
...
[this guide](/container-engine/how-to-guides/computer-vision/deploy-blip-with-cog) on writing a Dockerfile from scratch
