...
[the HTTP/1.X probe](/container-engine/explanation/health-probes/health-probes#http-1-x-protocol) checks the health of
...
[the protocol - exec](/container-engine/explanation/health-probes/health-probes#exec-protocol), will run the given
...
control over how the image is built. You can refer to [this guide](/container-engine/how-to-guides/computer-vision/deploy-blip-with-cog) on
...
[this guide](/container-engine/how-to-guides/gateway/enabling-ipv6#ipv6-with-cog-through-socat) for more information. Alternatively, you
