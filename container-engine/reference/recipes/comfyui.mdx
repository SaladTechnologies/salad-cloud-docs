...
Users can make an HTTP request to the provided endpoints and get back one or more outputs in base64 encoded form,
via Webhook, or uploaded to S3, Azure Blob Storage, or Hugging Face.
