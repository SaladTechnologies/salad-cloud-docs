...
[ComfyUI API](https://github.com/SaladTechnologies/comfyui-api) to facilitate horizontally scalable operation. Users can
make an HTTP request to the provided endpoints and get back one or more outputs in base64 encoded form, via Webhook, or
via S3.
