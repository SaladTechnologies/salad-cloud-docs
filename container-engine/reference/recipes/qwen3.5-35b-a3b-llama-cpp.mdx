---
title: Qwen3.5-35B-A3B with llama.cpp Recipe
sidebarTitle: Qwen3.5-35B-A3B
description: Serve Qwen3.5-35B-A3B with llama.cpp as an OpenAI-compatible API for OpenClaw, OpenCode, and other tools.
---
...
This recipe runs `Qwen3.5-35B-A3B` with the official [llama.cpp](https://github.com/ggml-org/llama.cpp) CUDA server on a
...
<Callout variation="note">The first startup downloads the model, so it can take up to about 20 minutes before the deployment becomes ready.</Callout>
...
- [<Icon icon="github" size="24" /> Recipe Source](https://github.com/SaladTechnologies/salad-recipes/tree/master/recipes/qwen3.5-35b-a3b-llama-cpp)
