...
![](/container-engine/images/bligcog/blipcog1.png)
![](/container-engine/images/bligcog/blipcog2.png)

The Cog HTTP prediction server is now using IPv6. The port number is configurable via the environment variable - ‘PORT’. 
![](/container-engine/images/bligcog/blipcog3.png)
...
![](/container-engine/images/bligcog/blipcog4.png)
...
![](/container-engine/images/bligcog/blipcog5.png)
