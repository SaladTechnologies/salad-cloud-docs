...
2. **Create a Model Repository.** The [model repository](https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/user_guide/model_repository.html) is the directory where you place the models that you want Triton to serve. Ensure your models are organized in the following folder structure:  
    ```java
    model-name/ 
    ├── 1 
    │ └── model_file 
...
Create a new file called `Dockerfile` and open it in your preferred text editor.
Add the base image to your Dockerfile. Example:
...
Refer to the official Salad documentation on enabling IPv6: [Enabling IPv6](https://docs.salad.com/container-engine/gateway/enabling-ipv6)
...
#### Step 6: Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [Salad Public API](https://docs.salad.com/api-reference/container_groups/create-a-container-group)

Follow this easy steps to deploy your container on salad: [Quickstart - SaladCloud](https://docs.salad.com/container-engine/quickstart)

## Usage Example

**Accessing the Application:** Copy the Access Domain Name from the Container Group created above. Detailed instructions on how to find it can be found here: [Setup Container Gateway](https://cloud-support.salad.com/article/421-setup-container-gateway#:~:text=Enable%20the%20Container%20Gateway%20%28Load%20Balancer%29%20on%20the,Domain%20Name%20is%20located%20in%20the%20Container%20Group.)
