...
#### Step 6: Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [Salad Public API](/reference/saladcloud-api/container_groups/create-a-container-group)
