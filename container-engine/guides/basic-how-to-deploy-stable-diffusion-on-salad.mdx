...
Find a docker image of your preferred stable diffusion inference server. Here are some popular ones that we’ve verified work on Salad. We’ll be using ComfyUI for this example, but the principles covered apply to all of these options.
    1. ComfyUI
        ...
        2. Docker Image: [ghcr.io/ai-dock/comfyui:latest-cuda](http://ghcr.io/ai-dock/comfyui:latest-cuda)
        3. Model Directory: `/opt/ComfyUI/models`
        4. Custom Node Directory: `/opt/ComfyUI/custom_nodes/`
    2. Automatic1111
        ...
        2. Docker Image: `saladtechnologies/a1111:ipv6-latest` 
        3. Data Directory: `/data`
        4. Model Directory: `/data/models`
        5. Extension Directory: `/data/config/auto/extensions`
        6. Controlnet Model Directory (If controlnet extension is installed): `/data/config/auto/extensions/sd-webui-controlnet/models`
    3. SD.Next
        1. Git Repo: [https://github.com/SaladTechnologies/sdnext](https://github.com/SaladTechnologies/sdnext)
        2. Docker Image: `saladtechnologies/sdnext:base`
        3. Data Directory: `/webui/data`
...
Download any model files you plan to use. For our example, we’re going to use [Dreamshaper 8](https://civitai.com/models/4384/dreamshaper) , available on [Civitai.com](http://Civitai.com) ([https://blog.salad.com/civitai-salad/](https://blog.salad.com/civitai-salad/))
...
2. (Recommended) Run the docker image locally to confirm it works as expected
    ...
    1. Go to [http://localhost:8188/](http://localhost:8188/) in your browser. You should see something like this: 
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled.png)
        
    2. Click “Queue Prompt” to generate an image. Mine came out like this.
        
        ![ComfyUI_00001_ (1).png](container-engine/guides/stable-diffusion-guide-images/ComfyUI_00001__(1).png)
        
    3. Enable Dev Mode Options via the settings menu
        
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%201.png)
        
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%202.png)
        
        You should see a new option in the menu, “Save (API Format)”:
        
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%203.png)
    ...
    5. Submit the prompt to the wrapper API on port 3000, using Postman or any http request tool of your choice.
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%204.png)
    ...
    7. Decode the base64 encoded string into your image. You can do this in a free browser tool such as https://codebeautify.org/base64-to-image-converter
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%205.png)
...
## Push and Deploy Your Docker Image
    ...
    2. Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [Salad Public API](https://docs.salad.com/api-reference/container_groups/create-a-container-group)
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%206.png)
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%207.png)
        
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%208.png)
        
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%209.png)
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%2010.png)
...
## Interact with Your Deployment
    1. Wait for the deployment to be ready.
        1. First, Salad pulls your container image into our own internal high-performance cache.
            ...
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%2011.png)
            
        2. Next, Salad locates eligible nodes for your workflow, based on the configuration you provided.
            
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%2012.png)
            
        3. Next, Salad begins downloading the cached container image to the nodes that have been assigned to your workload.
            
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%2013.png)
        ...
        4. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
            ...
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%2014.png)
            
    2. Submit your prompt to the provided Access Domain Name. You will get back a json response within a few seconds. See step 6 for how to submit the request and process the response.
        
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/Untitled%2015.png)