---
title: 'How to Use the Salad Terminal'
---
...
viewer in your image if you intend to use the Salad Terminal for debugging.
...
Please Note: We do not recommend using the Salad Terminal for final deployment and configuration of each replica as this
is considered stateful. Salad deployments should be configured to be stateless, as they could be reallocated to another
machine at any moment. This could mean you need to regularly re-configure replicas every time they adjust.
