...
<iframe src="https://player.vimeo.com/video/918054913?h=00416532b2&title=0&byline=0&portrait=0" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
...
Now that you have a container locally, you will need to push that container image up to a container registry so it can be deployed on Salad. You can push to any of the [supported container registries](/container-engine/container-registries), but for this guide we will use Docker Hub.
...
[Deployment Guide](/container-engine/deploy-containers)
