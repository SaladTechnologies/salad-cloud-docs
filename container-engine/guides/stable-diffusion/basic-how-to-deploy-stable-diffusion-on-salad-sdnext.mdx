...
Note that we set the `HOST` environment variable to `0.0.0.0` for local development.
The default value of `HOST` is `[::]`, which is the ipv6 address that Salad uses to route traffic to your container.
...
![Untitled](container-engine/guides/stable-diffusion-guide-images/sunset-base64-2.png)
...
```
    ...
    2. Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [Salad Public API](https://docs.salad.com/api-reference/container_groups/create-a-container-group)
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-1.png)
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-2.png)
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-a1111-3.png)
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-3.png)
...
## Interact with Your Deployment
    1. Wait for the deployment to be ready.
        1. First, Salad pulls your container image into our own internal high-performance cache.
            ...
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-4.png)
            
        2. Next, Salad locates eligible nodes for your workload, based on the configuration you provided.
            
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-5.png)
            
        3. Next, Salad begins downloading the cached container image to the nodes that have been assigned to your workload.
            
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-6.png)
        ...
        4. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
            ...
            ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-7.png)
    ...
    2. Submit your prompt to the provided Access Domain Name. You will get back a json response within a few seconds. See [above](#build-and-test-your-docker-image) for how to submit the request and process the response.
        ...
        ![Untitled](container-engine/guides/stable-diffusion-guide-images/deploy-sdnext-8.png)