...
Detecting interrupted nodes typically involves a heartbeat mechanism, where if a node hasn’t requested work within a certain amount of time, assume it’s dead (this can be verified with the [Salad API](https://docs.salad.com/api-reference/container_groups/get-container-group-instance-by-instance-id)), and reassign work as needed.