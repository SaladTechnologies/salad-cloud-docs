...
- Docker Image: [ghcr.io/ai-dock/comfyui:v2-cuda-12.1.1-base-22.04](http://ghcr.io/ai-dock/comfyui:v2-cuda-12.1.1-base-22.04)
...
# generated images.
ADD https://github.com/SaladTechnologies/comfyui-wrapper/releases/download/1.1.0/comfyui-wrapper .
...
```bash
docker build -t saladtechnologies/comfyui:flux1-schnell-fp8 .
```
...
2. (Recommended) Run the docker image locally to confirm it works as expected
    ...
    saladtechnologies/comfyui:flux1-schnell-fp8
    ```
...
```bash
docker push saladtechnologies/comfyui:flux1-schnell-fp8
```
