...
## Find a Docker Image
Find a docker image of Automatic1111.
Here's one we've verified works on Salad:

**Automatic1111**
- Git Repo: [https://github.com/SaladTechnologies/stable-diffusion-webui-docker](https://github.com/SaladTechnologies/stable-diffusion-webui-docker)
