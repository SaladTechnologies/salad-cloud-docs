---
title: "How to Deploy Stable Diffusion (Automatic1111)"
...
Navigate to [http://localhost:7860/docs](http://localhost:7860/docs) in your browser to see the API docs for Automatic1111.

3. Test a Text-to-Image request

See [the docs](http://localhost:7860/docs#/default/text2imgapi_sdapi_v1_txt2img_post) for more information on submitting a text-to-image request.
...
4. Decode the base64 encoded string into your image. You can do this in a free browser tool such as https://codebeautify.org/base64-to-image-converter
        
![Decoded Image](/container-engine/guides/stable-diffusion-guide-images/sunset-base-64.png)
...
```
    ...
    2. Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [Salad Public API](https://docs.salad.com/api-reference/container_groups/create-a-container-group)
        ...
        ![Create a Container Group](/container-engine/guides/stable-diffusion-guide-images/Untitled%206.png)
        ...
        ![Set up the image, and the replica count.](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-1.png)
        ...
        ![Choose appropriate hardware](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-2.png)
        ...
        ![Enable a way to access the container group](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-3.png)
        ...
        ![Configure probes for better reliability](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-4.png)
...
## Interact with Your Deployment
    1. Wait for the deployment to be ready.
        1. First, Salad pulls your container image into our own internal high-performance cache.
            ...
            ![The container group is preparing](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-5.png)
            
        2. Next, Salad locates eligible nodes for your workload, based on the configuration you provided.
            
            ![Container group is deploying, instances are allocating](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-6.png)
            
        3. Next, Salad begins downloading the cached container image to the nodes that have been assigned to your workload.
            
            ![Container group is deploying, instances are downloading](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-7.png)
        ...
        4. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
            ...
            ![Container group is running, 1 or more instances is running](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-8.png)
    ...
    2. Submit your prompt to the provided Access Domain Name. You will get back a json response within a few seconds. See [above](#build-and-test-your-docker-image) for how to submit the request and process the response.
        ...
        ![Submit an API request to verify everything is working](/container-engine/guides/stable-diffusion-guide-images/deploy-a1111-9.png)