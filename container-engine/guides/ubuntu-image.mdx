...
We offer a 1-click deploy Ubuntu image to let you get quickly up and running on Salad and to test our services. This image includes some basic tools and applications. You can find it [here](ghcr.io/saladtechnologies/recipe-base-ubuntu:0.1), and the open-source repository is available [here](https://github.com/SaladTechnologies/salad-recipes/tree/master/src/base-ubuntu)
