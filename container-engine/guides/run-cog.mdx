...
The provided [command and its arguments](https://docs.salad.com/container-engine/specifying-a-command) override both the
...
[the HTTP/1.X probe](https://docs.salad.com/container-engine/health-probes#http-1-x-protocol) checks the health of an
HTTP service running inside the container by sending an HTTP GET request and checking the response code.
...
Because the [command and its arguments](https://docs.salad.com/container-engine/specifying-a-command) override both the
...
The Readiness Probe with [the protocol - exec](https://docs.salad.com/container-engine/health-probes#exec-protocol),
...
[this guide](https://docs.salad.com/container-engine/guides/deploy-blip-with-cog#build-the-container-image) on writing a
...
[this guide](https://docs.salad.com/container-engine/gateway/enabling-ipv6#ipv6-with-cog-through-socat) for more
