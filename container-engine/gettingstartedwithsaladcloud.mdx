...
- **Why do owners share GPUs with Salad?**
  - Owners earn rewards (in the form of Salad balance) for sharing their compute. Many compute providers earn $100 - $200 per month on Salad as a reward that they exchange for games, gift cards and more.
...
- **Are consumer-grade GPUs good for AI workloads?**
  - Yes. Many consumer GPUs on our network offer comparable or even better performance for AI workloads. You can read all our [benchmarks here](https://blog.salad.com/).
...
- **What is the right Salad product for my workload?**
  ...
  - A description of four product lines goes here
...
- **What about compliance on Salad?**
  - We are SOC 2 Type 1 compliant. You can read more about our compliance [here](https://blog.salad.com/salad-soc-2-certification/).
