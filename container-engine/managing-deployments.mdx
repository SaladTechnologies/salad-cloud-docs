...
- You can modify hardware resource requirements, such as the number of vCPUs, Memory (RAM), GPUs, and [Disk Space](/container-engine/disk-space).
...
- If enabled, you can edit the [Container Gateway](/container-engine/networking) Port. Note: the edit Container Group functionality doesn't allow for the Container Gateway to be disabled, enabled, or authentication to be changed.
