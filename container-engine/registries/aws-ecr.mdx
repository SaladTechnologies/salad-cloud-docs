...
containers and containerised applications. This guide will walk you through the process of deploying containers from
Amazon Elastic Container Registry to the Salad Portal.
...
service dropdown option, choose "AWS Elastic Container Registry" and provide the following information:

- Image name (example: `docker.io/{username}/{my-container-image}:{version/latest}`)

<img src="/container-engine/images/569dbfa-image.png" />
