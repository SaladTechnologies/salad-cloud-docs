...
> 📘 Prerequisites
>
> The examples that follow can be found on [github](https://github.com/SaladTechnologies/saladcloud-job-queue-worker-sdk). If you want to follow along with the sample images, download them to your pc with
>
