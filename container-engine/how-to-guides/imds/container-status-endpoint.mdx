...
[startup probe](/container-engine/explanation/health-probes/startup-probes), but not completed its
[readiness probe](/container-engine/explanation/health-probes/readiness-probes), we'll see this:
