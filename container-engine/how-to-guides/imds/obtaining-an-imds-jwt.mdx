...
[authenticate to external services](/container-engine/tutorials/security/jwt-authentication), such as your own API or a third-party service.

You can find code samples and the full API reference in the [API Reference Docs](/reference/imds/get-token).

This JWT can also be used to authenticate with [S4](/storage/explanation/overview) for temporary file
storage.
