...
To handle long-running requests like this, we can use [SaladCloud's Job Queue](/container-engine/explanation/core-concepts/job-queues).
...
experimenting with [autoscaling](/container-engine/explanation/autoscaling/autoscaling#autoscaling-overview) to handle more requests,
