...
'twitter:description':
  'A step-by-step guide to creating and deploying a video generation API on SaladCloud, using ComfyUI and ComfyUI API.'
'og:image': '/container-engine/images/video-gen-social.png'
'og:image:width': 1024
'og:image:height': 540
'twitter:image': '/container-engine/images/video-gen-social.png'
...
<video controls className="w-full aspect-video" src="/container-engine/images/ltx-sample.mp4"></video>
...
![](/container-engine/images/export-comfy-ltx-workflow.png)
...
![](/container-engine/images/video-clip-endpoint.png)
...
[SaladCloud's Job Queue](/container-engine/explanation/core-concepts/job-queues). With the job queue, we can submit our
...
- We're going to connect the container group to the job queue we made in the previous step. Configure the job queue for
  ...
  [learn more about it here](/container-engine/explanation/autoscaling/autoscaling#autoscaling-overview).
...
![](/container-engine/images/video-gen-service-preparing.png)
...
![](/container-engine/images/video-gen-service-deploying.png)
...
![](/container-engine/images/video-gen-service-running.png)
...
experimenting with [autoscaling](/container-engine/explanation/autoscaling/autoscaling#autoscaling-overview) to handle
more requests, and reduce costs during periods of low demand.
