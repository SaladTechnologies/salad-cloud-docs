...
[Tailscale must run in userspace networking mode on Salad nodes](/container-engine/explanation/tailscale-integration/solution-overview#scenarios-and-protocols),
