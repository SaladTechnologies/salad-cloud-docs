...
[continuously monitor performance](/tutorials/performance-monitoring) to filter nodes based on specific criteria. Please
refer to [this guide](/tutorials/high-performance-apps#implement-real-time-performance-monitoring) for more details.
