...
- You can edit the [Health Check Probes](/container-engine/explanation/health-probes/health-probes) (Startup, and
  Liveness).
- You can edit the [Command](/container-engine/how-to-guides/specifying-a-command).
- If enabled, you can edit the [Container Gateway](/container-engine/explanation/networking-security/networking) Port. Note: the edit Container Group
...
- You can modify or enable/disable the
  [External Logging](/container-engine/explanation/core-concepts/external-logging) Services.
