...
- You can edit the [Health Check Probes](/container-engine/explanation/infrastructure-platform/health-probes) (Startup, and
  Liveness).
- You can edit the [Command](/container-engine/how-to-guides/specifying-a-command).
- If enabled, you can edit the [Container Gateway](/container-engine/explanation/infrastructure-platform/networking) Port.
  Note: the edit Container Group functionality doesn't allow for the Container Gateway to be disabled, enabled, or
  authentication to be changed.
- You can modify or enable/disable the [External Logging](/container-engine/explanation/infrastructure-platform/external-logging)
  Services.
