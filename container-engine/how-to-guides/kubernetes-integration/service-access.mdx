...
[real-time inference](/container-engine/how-to-guides/real-time-inference/build-redis-queue),
[batch processing and long-running tasks](/container-engine/explanation/long-running-tasks/solution-overview), and
various types of applications (streaming/non-streaming, synchronous/asynchronous), can be effectively implemented.
Supported use cases encompass LLMs, image/video generation, transcription and molecular dynamics simulation, etc.
...
Please check [this link](/container-engine/how-to-guides/real-time-inference/use-container-gateway#key-considerations)
for more details.
