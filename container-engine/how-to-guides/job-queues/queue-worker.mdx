...
[Container Registries](/container-engine/explanation/core-concepts/container-registries).
...
- By default, the Worker logging level is set to `error`. Logs will be sent to the
  ...
  [external logging](/container-engine/explanation/core-concepts/external-logging) tools. You can adjust the logging
...
- If you choose not to use any Startup and/or Readiness probes, the Job Queue Worker will immediately start to look for
  ...
  [Read more about health probes here. ](/container-engine/explanation/health-probes/health-probes)
