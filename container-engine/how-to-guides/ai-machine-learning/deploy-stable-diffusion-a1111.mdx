...
sidebarTitle: 'Stable Diffusion (A1111)'
...
![Decoded Image](/container-engine/images/sunset-base-64.png)
...
```
    ...
    2. Deploy your image on Salad, using either the [Portal](https://portal.salad.com) or the [SaladCloud Public API](/reference/saladcloud-api/container-groups/create-container-group)
        ...
        ![Create a Container Group](/container-engine/images/salad-create-container-group.png)
        ...
        ![Set up the image, and the replica count.](/container-engine/images/deploy-a1111-1.png)
        ...
        ![Choose appropriate hardware](/container-engine/images/deploy-a1111-2.png)
        ...
        ![Enable a way to access the container group](/container-engine/images/deploy-a1111-3.png)
        ...
        ![Configure probes for better reliability](/container-engine/images/deploy-a1111-4.png)
...
## Interact with Your Deployment
    ...
    1. Wait for the deployment to be ready.
        1. First, SaladCloud pulls your container image into our own internal high-performance cache.
            ...
            ![The container group is preparing](/container-engine/images/deploy-a1111-5.png)

        2. Next, SaladCloud locates eligible nodes for your workload, based on the configuration you provided.

            ![Container group is deploying, instances are allocating](/container-engine/images/deploy-a1111-6.png)

        3. Next, SaladCloud begins downloading the cached container image to the nodes that have been assigned to your workload.

            ![Container group is deploying, instances are downloading](/container-engine/images/deploy-a1111-7.png)
        ...
        4. Eventually, you will see instances listed as “running”, with a green check in the “ready” column.
            ...
            ![Container group is running, 1 or more instances is running](/container-engine/images/deploy-a1111-8.png)
    ...
    2. Submit your prompt to the provided Access Domain Name. You will get back a json response within a few seconds. See [above](#build-and-test-your-docker-image) for how to submit the request and process the response.
        ...
        ![Submit an API request to verify everything is working](/container-engine/images/deploy-a1111-9.png)
