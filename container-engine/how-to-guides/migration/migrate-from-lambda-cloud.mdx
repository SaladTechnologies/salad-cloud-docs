...
SaladCloud pricing shown below uses current **Lowest** priority rates (formerly called "Batch") for the listed GPU
instance configuration. Higher priority tiers cost more but provide greater availability guarantees.

| Use Case                       | Lambda GPU              | Lambda $/hr | SaladCloud GPU   | SaladCloud $/hr | Savings |
| ------------------------------ | ----------------------- | ----------- | ---------------- | --------------- | ------- |
| LLM Inference (7–13B)          | A10 (24 GB)             | ~$1.29      | RTX 4090 (24 GB) | ~$0.160         | ~88%    |
| Image Generation (SD/FLUX)     | A10 (24 GB)             | ~$1.29      | RTX 3090 (24 GB) | ~$0.090         | ~93%    |
| Transcription (Whisper)        | Quadro RTX 6000 (24 GB) | ~$0.69      | RTX 3090 (24 GB) | ~$0.090         | ~87%    |
| Batch Embeddings               | A100 PCIe (40 GB)       | ~$1.99      | RTX 4090 (24 GB) | ~$0.160         | ~92%    |
| LLM Inference (34B–70B quant.) | A6000 (48 GB)           | ~$1.09      | RTX 5090 (32 GB) | ~$0.250         | ~77%    |

**Example: 100 GPU-hours of inference per day**

- **Lambda (A10):** 100 × $1.29/hr = ~$3,870/month
- **SaladCloud (RTX 4090, lowest):** 100 × $0.160/hr = ~$480/month
