...
that it is failing to set the [deletion cost](/container-engine/explanation/infrastructure-platform/instance-deletion-cost), because we are
not running on SaladCloud, but this is not an issue for our purposes.
