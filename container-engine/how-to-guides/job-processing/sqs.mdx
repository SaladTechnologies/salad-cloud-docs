...
S3-compatible storage will make it easier to switch storage providers in the future if
you choose to do so.
...
<Frame caption="Granting no permissions to the job-submitter user">
  <img src="/container-engine/images/iam-submitter-st2.png" alt="Granting no permissions to the job-submitter user" />
</Frame>
...
<Frame caption="Creating an access key for the job-worker user">
  <img src="/container-engine/images/iam-worker-create-key.png" alt="Creating an access key for the job-worker user" />
</Frame>
...
<Frame caption="The SQS Console showing 10000 messages in the queue">
  <img src="/container-engine/images/sqs-10k-messages.png" alt="The SQS Console showing 10000 messages in the queue" />
</Frame>
...
<Frame caption="Setting the job priority and storage requirements">
  <img src="/container-engine/images/sqs-cg-create-3.png" alt="Setting the job priority and storage requirements" />
</Frame>
