...
to use S3-compatible storage will make it easier to switch storage providers in the
...
<Frame caption="Choosing the number of nodes and RabbitMQ version">
  <img src="/container-engine/images/rabbitmq-create-3.png" alt="Choosing the number of nodes and RabbitMQ version" />
</Frame>
...
<Frame caption="Disabling the consumer timeout">
  <img src="/container-engine/images/rabbitmq-disable-consumer-timeout.png" alt="Disabling the consumer timeout" />
</Frame>
...
<Frame caption="Adding a deadletter exchange">
  <img src="/container-engine/images/rabbitmq-create-deadletter-exchange.png" alt="Adding a deadletter exchange" />
</Frame>
...
<Frame caption="Setting the trigger to run every 5 minutes">
  <img src="/container-engine/images/rabbitmq-workers-trigger.png" alt="Setting the trigger to run every 5 minutes" />
</Frame>
