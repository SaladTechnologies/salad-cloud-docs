...
First, you'll need the domain name of your container group or recipe deployment and your API key. You can view and copy your API key at [portal](https://portal.salad.com/api-key).

Obtain the domain name in the details of your deployment, e.g.

<img src="container-engine\images\6b459be-image.png" />
...
<img src="container-engine\images\1fc4ec5-image.png" />
