...
First, you'll need the domain name of your container group or recipe deployment and your API key. You can view and copy
your API key at [portal](https://portal.salad.com/api-key).
