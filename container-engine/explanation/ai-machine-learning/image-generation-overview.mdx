...
1. ComfyUI
   1. Guide:
      [ComfyUI](/container-engine/how-to-guides/ai-machine-learning/deploy-stable-diffusion-comfy)
...
2. Automatic1111
   1. Guide:
      [Automatic1111](/container-engine/how-to-guides/ai-machine-learning/deploy-stable-diffusion-a1111)
   1. Git Repo:
...
3. SD.Next
   1. Guide:
      [SD.Next](/container-engine/how-to-guides/ai-machine-learning/deploy-stable-diffusion-sdnext)
...
4. Fooocus:
   1. Guide:
      [Fooocus](/container-engine/how-to-guides/ai-machine-learning/deploy-stable-diffusion-fooocus)
