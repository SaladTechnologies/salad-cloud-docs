...
1. Ensure that the [**Job Queue**](/container-engine/explanation/core-concepts/job-queues) is enabled for your container group.
2. Verify that your application can handle scaling with multiple container instances.
3. Review the [Autoscaling Settings](/container-engine/reference/autoscaling/settings) to understand how to fine-tune autoscaling for
   your workloads.
...
Ready to configure autoscaling? Learn more about the available [Settings](/container-engine/reference/autoscaling/settings) or
