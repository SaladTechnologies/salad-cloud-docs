...
<img src="/container-engine/images/portal-select-logging-service.png" />

Finally, fill out the form fields and press Configure.

<img src="/container-engine/images/portal-configure-logging-service.png" />

> 📘 Don't have an external logging provider?
>
> Check out the [Container Logs](/container-engine/explanation/container-groups/container-logs) feature in the SaladCloud Portal.
