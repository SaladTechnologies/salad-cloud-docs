...
- **SOC 2 Type 2 attested** and **ISO27001 certified** datacenter partners
...
SaladCloud Secure servers are equipped with **high-speed local storage** designed for performance during active compute
jobs.
...
| **Security**      | SOC 2                         | SOC 2 Type 2, ISO27001, 24/7 datacenter security |
