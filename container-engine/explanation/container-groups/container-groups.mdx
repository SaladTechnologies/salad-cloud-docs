...
- **[CPU and RAM Utilization](/container-engine/explanation/container-groups/resource-utilization)**: View the CPU and
  RAM each running instance is using, relative to the vCPU and RAM you requested. Reported automatically, with no
