...
These events describe phases of the [deployment lifecycle](/container-engine/explanation/container-groups/deployment-lifecycle) on
SaladCloud.
...
If you have setup [health probes](/container-engine/explanation/health-probes/health-probes) for your container group,
