...
1. ComfyUI
   1. Guide: [ComfyUI](/container-engine/how-to-guides/image-generation/basic-how-to-deploy-stable-diffusion-on-salad-comfy)
...
2. Automatic1111
   1. Guide: [Automatic1111](/container-engine/how-to-guides/image-generation/basic-how-to-deploy-stable-diffusion-on-salad-a1111)
   1. Git Repo:
...
3. SD.Next
   1. Guide: [SD.Next](/container-engine/how-to-guides/image-generation/basic-how-to-deploy-stable-diffusion-on-salad-sdnext)
...
4. Fooocus:
   1. Guide: [Fooocus](/container-engine/how-to-guides/image-generation/basic-how-to-deploy-stable-diffusion-on-salad-fooocus)
