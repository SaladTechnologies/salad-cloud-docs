...
1. After creating the organization and project, Salad will prompt you to select a product. Choose "Create Container Group" from the options presented.  
   <img src="/container-engine/images/453f6c6-image.png"/>
...
3. Specify the number of replicas (e.g., "5") that you want to deploy
   ...
   <img src="/container-engine/images/7bfb490-b7fcc7e-image.png"/>

4. Scroll down to the "Resource" section and choose the required vCPU, memory size needed for your container.  
   <img src="/container-engine/images/304f4f6-909d05c-image.png"/>
...
<img src="/container-engine/images/a8abbe5-image.png"/>
