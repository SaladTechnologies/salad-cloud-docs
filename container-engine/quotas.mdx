...
Each Organization has a Quota which defines the maximum number of container groups, recipes or replicas that can be deployed on Salad. You can request an increase to your Quota via the portal, or by reaching out to our support team [here](mailto:cloud@salad.com).
