...
1. Put the large files in Cloud Storage, such as AWS S3，Cloudflare R2 or YouTube. Select the appropriate service tier and lifecycle policy (Hot/Warm/Cold/Archive) based on their access patterns to optimize costs.
