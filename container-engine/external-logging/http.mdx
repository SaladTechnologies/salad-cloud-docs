...
To enable external logging service via HTTP on Salad Cloud, you need to configure your Container Group Deployment with
the appropriate HTTP endpoint details. Salad Cloud External Logging supports HTTP endpoints for receiving logs. This
...
while container group creation or configuration process at salad portal, locate the "External Logging Services" section
...
<img src="/container-engine/images/eec4c3f-image.png" />
...
<img src="/container-engine/images/2acf3d1-image (1).png" />
