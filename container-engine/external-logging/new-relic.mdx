...
2. Ingestion Key: This is long random string used to securely connect your Salad containers to New Relic.
   You can find this key by clicking your name in the lower left hand corner of the screen (1). This opens a menu, where
   you will see an option for "API Keys"(2)
