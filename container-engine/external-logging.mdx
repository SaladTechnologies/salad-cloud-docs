...
<img src="/container-engine/images/aa011bd-image.png" />
...
>
> Under the hood, Salad Cloud uses [Fluent Bit](https://docs.fluentbit.io/manual/pipeline/outputs) to collect and send
...
<img src="/container-engine/images/a2a3a75-image.png" />

Finally, fill out the form fields and press Configure.

<img src="/container-engine/images/d8a6ecb-image.png" />
