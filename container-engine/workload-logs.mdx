...
`startedAt` - The UTC timestamp when your container was started on the node. If this field is `null`, the container failed before reaching a started state. You can learn more about different container states [here](/container-engine/deployment-lifecycle).
