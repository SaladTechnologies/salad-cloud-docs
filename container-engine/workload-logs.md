...
`startedAt` - The UTC timestamp when your container was started on the node. If this field is `null`, the container failed before reaching a started state. You can learn more about different container states [here](https://docs.salad.com/docs/deployment-lifecycle).
